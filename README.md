...
| ⬜ **IODA Packet Loss** | unknown | 598ms | 0.0% |
| ⬜ **Psiphon Conduit Stats** | unknown | 227ms | 1.6% |
...
| 🟥 **Aparat** | down | 750ms | 17.8% |
| 🟥 **Asiatech** | down | 25008ms | 17.4% |
| 🟥 **Bale Messenger** | down | 5541ms | 27.0% |
| 🟥 **CafeBazaar** | down | 6194ms | 13.9% |
| 🟥 **DadehNegar** | down | 0ms | 0% |
| 🟥 **Digikala** | down | 0ms | 0% |
| 🟥 **Digikala** | down | 1467ms | 17.4% |
| 🟥 **Electro** | down | 0ms | 0% |
...
| 🟥 **Shecan DNS** | down | 6658ms | 0% |
| 🟥 **Shecan** | down | 0ms | 0% |
| 🟥 **Shiraz** | down | 0ms | 0% |
| 🟥 **Sindad** | down | 0ms | 0% |
| 🟥 **Snapp** | down | 622ms | 0% |
| 🟥 **Soroush** | down | 0ms | 0% |
| 🟥 **Soroush** | down | 5624ms | 2.2% |
| 🟥 **TIC** | down | 0ms | 0% |
| 🟥 **TIC** | down | 0ms | 0% |
| 🟥 **TIC** | down | 0ms | 0% |
| 🟥 **TIC** | down | 0ms | 0% |
...
| 🟨 **IODA MERIT Telescope** | degraded | 498ms | 64.2% |
| 🟨 **Psiphon Reachability** | degraded | 468ms | 49.6% |
| 🟨 **Signal Blocking** | degraded | 472ms | 29.7% |
| 🟩 **ArvanCloud (AS205585)** | up | 317ms | 99.8% |
| 🟩 **ArvanCloud** | up | 2070ms | 99.5% |
| 🟩 **Asiatech (AS43754)** | up | 292ms | 99.9% |
| 🟩 **DCI / TIC (AS12880)** | up | 489ms | 99.9% |
| 🟩 **DPI / Middlebox** | up | 539ms | 84.4% |
| 🟩 **Eitaa** | up | 738ms | 24.7% |
| 🟩 **Facebook Blocking** | up | 468ms | 45.0% |
| 🟩 **IODA Active Probing** | up | 497ms | 82.5% |
| 🟩 **IODA BGP Visibility** | up | 495ms | 99.9% |
| 🟩 **IODA Google Traffic** | up | 500ms | 60.3% |
| 🟩 **IODA Outage Alerts** | up | 323ms | 81.7% |
...
| 🟩 **Rubika** | up | 1012ms | 82.6% |
| 🟩 **Shatel (AS31549)** | up | 485ms | 99.9% |
| 🟩 **TIC Announced Prefixes** | up | 315ms | 99.2% |
| 🟩 **TIC Regional (AS58224)** | up | 461ms | 99.8% |
| 🟩 **Telegram Blocking** | up | 469ms | 43.8% |
| 🟩 **Tor Bridge Users (Iran)** | up | 358ms | 99.3% |
| 🟩 **Tor Reachability** | up | 469ms | 89.1% |
| 🟩 **Tor Relay Users (Iran)** | up | 353ms | 99.2% |
| 🟩 **Web Censorship** | up | 493ms | 70.5% |
| 🟩 **WhatsApp Blocking** | up | 462ms | 48.3% |
<!--END_STATUS_TABLE-->

> Last checked: 2026-05-14T20:27:53Z
