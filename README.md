...
| ⬜ **IODA Latency** | unknown | 906ms | 0.1% |
| ⬜ **IODA Packet Loss** | unknown | 692ms | 0.1% |
...
| 🟥 **Amirkabir University** | down | 10008ms | 20.6% |
| 🟥 **Aparat** | down | 796ms | 28.8% |
| 🟥 **Asiatech** | down | 10004ms | 28.1% |
| 🟥 **Bale Messenger** | down | 25000ms | 26.8% |
| 🟥 **CafeBazaar** | down | 7359ms | 22.6% |
| 🟥 **DadehNegar** | down | 0ms | 0% |
| 🟥 **Digikala** | down | 0ms | 0% |
| 🟥 **Digikala** | down | 1317ms | 28.2% |
| 🟥 **Eitaa** | down | 10003ms | 27.4% |
| 🟥 **Electro** | down | 0ms | 0% |
| 🟥 **Filimo** | down | 25008ms | 3.7% |
| 🟥 **IPM Research** | down | 10004ms | 0.3% |
| 🟥 **Irancell** | down | 10007ms | 28.4% |
| 🟥 **MobinNet** | down | 0ms | 0% |
...
| 🟥 **Pishgaman** | down | 0ms | 0% |
| 🟥 **Pishgaman** | down | 0ms | 0% |
| 🟥 **Respina** | down | 10004ms | 28.7% |
| 🟥 **Saman Bank** | down | 25000ms | 26.7% |
| 🟥 **Shaparak** | down | 10006ms | 25.1% |
| 🟥 **Sharif University** | down | 10004ms | 17.0% |
| 🟥 **Shatel** | down | 0ms | 0% |
| 🟥 **Shatel** | down | 10003ms | 28.7% |
| 🟥 **Shecan DNS** | down | 1166ms | 0% |
| 🟥 **Shecan** | down | 0ms | 0% |
| 🟥 **Shiraz** | down | 0ms | 0% |
| 🟥 **Sindad** | down | 0ms | 0% |
| 🟥 **Snapp** | down | 581ms | 0% |
...
| 🟨 **Facebook Blocking** | degraded | 592ms | 36.9% |
| 🟩 **ArvanCloud (AS205585)** | up | 536ms | 99.8% |
| 🟩 **ArvanCloud** | up | 665ms | 99.7% |
| 🟩 **Asiatech (AS43754)** | up | 390ms | 99.9% |
| 🟩 **DCI / TIC (AS12880)** | up | 554ms | 99.9% |
| 🟩 **DPI / Middlebox** | up | 590ms | 80.2% |
| 🟩 **IODA Active Probing** | up | 539ms | 71.9% |
| 🟩 **IODA BGP Visibility** | up | 548ms | 99.9% |
| 🟩 **IODA Google Traffic** | up | 552ms | 53.8% |
| 🟩 **IODA MERIT Telescope** | up | 528ms | 66.3% |
| 🟩 **IODA Outage Alerts** | up | 325ms | 77.8% |
