...
|---------|--------|----------|--------|
| ⬜ **DNS Tampering** | unknown | 195ms | 0% |
| ⬜ **IODA Latency** | unknown | 673ms | 0.2% |
| ⬜ **IODA Packet Loss** | unknown | 479ms | 0.2% |
...
| 🟥 **Amirkabir University** | down | 10015ms | 67.9% |
| 🟥 **Aparat** | down | 2720ms | 95.0% |
| 🟥 **Asiatech** | down | 10017ms | 92.9% |
| 🟥 **CafeBazaar** | down | 562ms | 74.6% |
| 🟥 **DadehNegar** | down | 0ms | 1% |
| 🟥 **Digikala** | down | 0ms | 1% |
| 🟥 **Digikala** | down | 6597ms | 93.1% |
| 🟥 **Eitaa** | down | 10013ms | 90.5% |
| 🟥 **Electro** | down | 0ms | 1% |
| 🟥 **Facebook Blocking** | down | 702ms | 0% |
| 🟥 **Filimo** | down | 25000ms | 12.1% |
| 🟥 **IPM Research** | down | 25000ms | 1.0% |
| 🟥 **Irancell** | down | 10006ms | 93.6% |
| 🟥 **MobinNet** | down | 0ms | 1% |
| 🟥 **Mobinhost** | down | 0ms | 1% |
| 🟥 **Mobinnet** | down | 10006ms | 91.7% |
| 🟥 **NetPitch** | down | 0ms | 1% |
...
| 🟥 **Pishgaman** | down | 0ms | 1% |
| 🟥 **Pishgaman** | down | 0ms | 1% |
| 🟥 **Respina** | down | 10003ms | 94.8% |
| 🟥 **Saman Bank** | down | 25000ms | 88.1% |
| 🟥 **Shaparak** | down | 10006ms | 82.7% |
| 🟥 **Sharif University** | down | 10014ms | 56.1% |
| 🟥 **Shatel** | down | 0ms | 1% |
| 🟥 **Shatel** | down | 25003ms | 94.8% |
| 🟥 **Shecan DNS** | down | 1112ms | 0% |
| 🟥 **Shecan** | down | 0ms | 1% |
| 🟥 **Shiraz** | down | 0ms | 1% |
| 🟥 **Signal Blocking** | down | 536ms | 0% |
| 🟥 **Sindad** | down | 0ms | 1% |
| 🟥 **Snapp** | down | 583ms | 0% |
| 🟥 **Soroush** | down | 0ms | 1% |
...
| 🟥 **TIC** | down | 0ms | 1% |
| 🟥 **Tapsi** | down | 1298ms | 0% |
| 🟥 **Telegram Blocking** | down | 599ms | 0% |
| 🟥 **Tor Snowflake** | down | 639ms | 0% |
| 🟥 **Unknown** | down | 0ms | 0% |
| 🟥 **Unknown** | down | 0ms | 0% |
| 🟥 **Unknown** | down | 0ms | 0% |
| 🟥 **Web Censorship** | down | 639ms | 46.3% |
| 🟥 **WhatsApp Blocking** | down | 600ms | 0% |
| 🟥 **ZapISP** | down | 0ms | 1% |
| 🟥 **Zi-Tel** | down | 0ms | 1% |
| 🟥 **irinter.net Score** | down | 402ms | 0% |
| 🟨 **IODA MERIT Telescope** | degraded | 461ms | 89.9% |
| 🟨 **IODA Outage Alerts** | degraded | 328ms | 95.0% |
| 🟨 **Psiphon Reachability** | degraded | 1045ms | 0% |
| 🟩 **ArvanCloud (AS205585)** | up | 643ms | 99.8% |
| 🟩 **ArvanCloud** | up | 364ms | 99.3% |
| 🟩 **Asiatech (AS43754)** | up | 553ms | 99.8% |
| 🟩 **Bale Messenger** | up | 768ms | 46.3% |
| 🟩 **DCI / TIC (AS12880)** | up | 561ms | 99.8% |
| 🟩 **DPI / Middlebox** | up | 1048ms | 91.9% |
| 🟩 **IODA Active Probing** | up | 471ms | 99.8% |
| 🟩 **IODA BGP Visibility** | up | 593ms | 99.8% |
| 🟩 **IODA Google Traffic** | up | 433ms | 95.7% |
| 🟩 **Iran ASN Count** | up | 480ms | 100% |
| 🟩 **Irancell (AS44244)** | up | 632ms | 99.8% |
...
| 🟩 **Tor Reachability** | up | 668ms | 96.0% |
| 🟩 **Tor Relay Users (Iran)** | up | 358ms | 98.6% |
<!--END_STATUS_TABLE-->

> Last checked: 2026-02-28T15:56:01Z
